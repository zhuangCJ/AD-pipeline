...
def AD_Iden(img_path_0, img_path_1, img_path_2):
...
def batch_AD_Iden(in_path, save_path):

    path_coronal = os.path.join(in_path, 'coronal')
    path_coronal_30 = os.path.join(in_path, 'coronal-30')
    ...
    for i, name in enumerate(name_list):
        the_type = AD_Iden(os.path.join(path_coronal, name), os.path.join(path_sagittal, name), os.path.join(path_coronal_30, name))
    ...
    workbook.save(os.path.join(save_path, 'AD_Identification.xls'))
